!(function(win) {
  ...
  if (viewport) {
    ...
    o &&
      ((initScaleValue = parseFloat(o[2])),
      (dprValue = parseInt(1 / initScaleValue)));
  } else {
    if (metaFlexible) {
      var o = metaFlexible
        .getAttribute("content")
      ...
      o &&
        ((dprValue = parseFloat(o[2])),
        (initScaleValue = parseFloat((1 / dprValue).toFixed(2))));
    }
  }
